                                            ...
                                            <div id="tk-overlay-form">
                                                <form>
                                                    ...
                                                    <div className="column one" style={{margin: 0}}>
                                                        <input onClick={this.edit} type="submit"
                                            ...
                                            <div id="tk-overlay-form">
                                                <form>
                                                    ...
                                                    <img className="tk-AppAvatarImg"
                                                         ...
                                                         width="50" height="50"/>
                                                    <label className="login-label tkFont1 tkFont-Form"
                                                           style={{textAlign: "center", width: 245 + "px"}}>Android, To
                                                        add this app, open the browser option menu and tap on Add to
                                                        homescreen.
                                                        The menu can be accessed by pressing the menu hardware button if
                                                        your device has one, or by tapping the top right menu
                                                        icon</label>
                                                </form>
                                            </div>
                                        </div>
