                                                ...
                                                <div id="tk-overlay-form">
                                                    <form>
                                                        ...
                                                        <div className="column one" style={{margin: 0}}>
                                                            <input onClick={() => this._handleClick.bind(this)}
                                                                   type="submit" value="Access to Private App"
                                                                   id="submit" className="tkFont-Bold"/>
                                                        </div>
                                                    ...
                                                    <form>
                                                        ...
                                                        <label className="login-label tkFont1 tkFont-Form"
                                                            ...
                                                            <p>Android, To add this app, open the browser option menu
                                                                <img src="tkImages/android-home-gorgias.png"
                                                                     width="20"/> and tap on Add to homescreen.</p>
                                                            <p>The menu can be accessed by pressing the menu hardware
                                                                button if your device has one, or by tapping the top
                                                                right menu icon <img
                                                                    src="tkImages/android-home-gorgias.png" width="20"/>
                                                            </p>
                                                        </label>
